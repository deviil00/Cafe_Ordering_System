    ...
    <TermsContainer>
      <TermsCard>
        ...
        <Paragraph>
          ...
          (collectively " Bombay Misal Vada Pav , we, our, us") collect, use,
          share, protect or otherwise process your information personal data
          through our website (hereinafter referred to as Platform). Please note
          ...
          access our Platform.Collection-We collect your personal data when you
          ...
          signup/registering or using our Platform such as name, date of birth,
          ...
          personal data to provide the services you request. To the extent we
          use your personal data to market to you, we will provide you the
          ability to opt-out of such uses. We use your personal data to assist
          sellers and business partners 1 in handling and fulfilling orders;
          ...
          account.Data Deletion and Retention- You have an option to delete your
          ...
          deleted, you will lose access to the account. We retain your personal
          data information for a period no longer than is required for the
          purpose for which it was collected or as required under any applicable
          law. However, we may retain data related to 2 you if we believe it may
          ...
          analytical and research purposes.Your RightsYou may access, rectify,
          ...
          providing your information, you consent to the collection, use,
          storage, disclosure and otherwise processing of your information on
          the Platform in accordance with this Privacy Policy. If you disclose
          to us any personal data relating to other people, you represent that
          ...
          such information to be necessary. Changes to this Privacy Policy-
        ...
        <Paragraph>
          ...
          for access or usage of domain name (“Website”), including the related
          mobile site and mobile application (hereinafter 3 referred to as
          “Platform”). The Platform is owned by Bombay Misal Vada Pav, a company
          incorporated under the Companies Act, 1956 with its registered office
          at G-2, La victriya, nr. Helios, galaxy circle, Pal, Surat 394510
          (hereinafter referred to as "Platform Owner", “we”, “us”, “our”). Your
          use of the Platform and services and tools are governed by the
          ...
          Use, wherever the context so requires "you", “your” or "user" shall
          mean any natural or legal person who has agreed to become a user/buyer
          on the Platform. ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM
          ...
          courts in Surat, Gujarat. All concerns or communications relating to
          these Terms must be communicated to us using the contact information
          provided on this website. Shipping Policy
        </Paragraph>

        <SubHeading>Processing Time </SubHeading>
        <Paragraph>
          All orders are delivered within 1-2 hours. Orders are not shipped or
          ...
          via email or phone. Shipping Time Domestic Shipping: Orders will be
          delivered within 1 -2 hours from the date of order confirmation.
          Please note that delivery times may be affected by factors beyond our
